...
type User struct {
	...
	IsAktif         string     `gorm:"column:is_aktif;not nulldefault:y" json:"is_aktif"`
	...
	SrID            Int32Array `gorm:"column:sr_id;default:null" json:"sr_id"`
	RayonID         Int32Array `gorm:"column:rayon_id;default:null" json:"rayon_id"`
	BranchID        Int32Array `gorm:"column:branch_id;default:null" json:"branch_id"`
	AreaID          Int32Array `gorm:"column:area_id;default:null" json:"area_id"`
